...
<body>
	...
	<div class="container">
		...
		<h1 align="center">Giant Eagle Auditor's Site</h1>
			<br>
			<div align="center">
			<h4>Click on the tabs below to check how we comply with the regulations:</h4>
			<br>
			</div>
			<div class="col-md-6 column">
				<form>
					<p align="center"><b>Check compliance with HIPAA Rules </b>
					<select id="setit" style="color: #0000FF" size="1" name="test" onchange="window.open(this.value,'','');">
					<option value="">Select one</option>
					    <option value="homepage.jsp">§ 164.502</option>
					    <option value="homepage.jsp">§ 164.503</option>
					     <option value="homepage.jsp">§ 164.504</option></select>
			...
			<div class="col-md-6 column">
				<form>
					<p align="center"><b>Check complicance with Safe Harbor Rules </b>
					<select id="setit" style="color: #0000FF" size="1" name="test" onchange="window.open(this.value,'','');">
					<option value="">Select one</option>
						<option value="homepage.jsp">§ 164.502</option>
					    <option value="homepage.jsp">§ 164.503</option>

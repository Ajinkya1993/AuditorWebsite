		...
		<h1 align="center">Giant Eagle Auditor's Site</h1>
			...
			<div class="col-md-4 column">
				<form method="get" action="viewLaw.do">
					...
					<br>
					§164.520 Notice of privacy practices for protected health information-- The system should provide a notice that is written in plain language and that contains the elements required by header.

		...
		<h1 align="center">Giant Eagle Auditor's Site</h1>
			...
			<div class="col-md-4 column">
				<form method="get" action="viewLaw.do">
					...
					<br>
					HIPAA § 164.510 Use and disclosure for which an authorization is required-- The system should document and retain signed and valid authorizations from individual users.

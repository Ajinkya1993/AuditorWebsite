...
<div class="container">
	<div class="row clearfix">
		<h1 align="center">How We Comply with HIPPA &#167 164.520</h1>
		...
		<!-- <div class="col-md-6 column"> -->
			...
			<font size = "4">
					<br>
					<b>HIPAA &#167 164.520</b> Notice of privacy practices for protected health information. (i) Header. The notice 
					must contain the following statement as a header or otherwise prominently displayed: “THIS NOTICE DESCRIBES 
					HOW MEDICAL INFORMATION ABOUT YOU MAY BE USED AND DISCLOSED AND HOW YOU CAN GET ACCESS TO THIS INFORMATION. 
					PLEASE REVIEW IT CAREFULLY.”
					<p>&nbsp;</p>
					<br>
					<b>Scenario:</b><br> Before customers enroll in the program, Giant Eagle must notice the customer of the privacy rules 
					and policies of how Giant Eagle will use their information. The notice from Giant Eagle should follow the 
					required format and contain required information by the statutes.
					<p>&nbsp;</p>
					<br>
					<b>Implementation:</b><br> The header of the privacy notice must contains the statement: "THIS NOTICE DESCRIBES 
					HOW MEDICAL INFORMATION ABOUT YOU MAY BE USED AND DISCLOSED AND HOW YOU CAN GET ACCESS TO THIS INFORMATION. 
					PLEASE REVIEW IT CAREFULLY."
					<br>
					<p>&nbsp;</p>
